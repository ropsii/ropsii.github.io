...
*Top: Actual screenshot from [Google’s Blog](https://blog.google/products/earth/most-stunning-images-from-google-earth/) set in font-weight: 300.<br> Bottom: Same text set in font-weight: 400 just for comparison.<br> Which one requires less effort to read?*
